    ...
    <section id="spiceshp-products">
        ...
        <div class="row">
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Cinnamon</h3>
                        <div class="price">1KG/LKR 5000.00</div>
                        <div class="cart">
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Cloves</h3>
                        <div class="price">1KG/LKR 2500.00</div>
                        <div class="cart">
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Dried Chillie</h3>
                        <div class="price">1KG/LKR 1600.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Nutmeg</h3>
                        <div class="price">1KG/LKR 1400.00</div>
                        <div class="cart">
                            <a class="btn  btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Turmeric</h3>
                        <div class="price">1KG/LKR 600.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Cocova</h3>
                        <div class="price">1KG/LKR 500.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Cardomom</h3>
                        <div class="price">1KG/LKR 13000.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Mace</h3>
                        <div class="price">1KG/LKR 6000.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Mustard Seeds</h3>
                        <div class="price">1KG/LKR 1100.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>White Pepper</h3>
                        <div class="price">1KG/LKR 2400.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        ...
                        <h3>Fenugreek</h3>
                        <div class="price">1KG/LKR 700.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        <img src="images/spiceShop/garcinia.jpg" class="imgSpiceShop mx-auto d-block img-fluid" alt="chillie powder">
                        <h3>Garcinia</h3>
                        <div class="price">1KG/LKR 300.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        <img src="images/spiceShop/tamarind.jpg" class="imgSpiceShop mx-auto d-block img-fluid" alt="garlic powder">
                        <h3>Tamarind</h3>
                        <div class="price">1KG/LKR 300.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        <img src="images/spiceShop/ginger.jpg" class="imgSpiceShop mx-auto d-block img-fluid" alt="cinnamon">
                        <h3>Ginger</h3>
                        <div class="price">1KG/LKR 600.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                    ...
                    <div class="box col-12 col-sm-6 col-md-4 col-lg-4 col-xl-2">
                        <img src="images/spiceShop/greenpepper.jpg" class="imgSpiceShop mx-auto d-block img-fluid" alt="cinnamon">
                        <h3>Green Pepper</h3>
                        <div class="price">1KG/LKR 450.00</div>
                        <div class="cart">
                            <a class="btn btn-outline-dark" href="#" role="button">Add to cart</a>
                        </div>
                    </div>
