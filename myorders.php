...
<input type="checkbox" name="" id="menu">
	...
	<div class="sidebar-menu">
		<ul>
			<li><a href="myAccount.php" class=""><span class="bi bi-person-circle"></span><span>My Account</span></a></li>
			<li><a href="cart.php" ><span class="bi bi-cart-fill"></span><span>My cart</span></a></li>
			<li><a href="#" class="active"><span class="bi bi-box2-heart"></span><span>My orders</span></a></li>
            <li><a href="spiceShop.php"><span class="bi bi-shop-window"></span><span>Spice Shop</span></a></li>
			<li><a href="#"><span class="bi bi-bell-fill"></span><span>Notification</span></a></li>
		</ul>
	</div>
</div>
